...
Pure JavaScript tool for making smart and high performance sticky sidebar.
  ...
  - Chart
    ...
    - [Observable Plot](https://github.com/observablehq/plot) - A concise API for exploratory data visualization.
  - SVG
  ...
  - Search
    ...
    - [FZF for JavaScript](https://github.com/ajitid/fzf-for-js) - Do fuzzy matching using FZF algorithm in JavaScript.
  - Visual
